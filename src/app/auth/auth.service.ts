...
export class AuthService {
  private static readonly signUpUrl = `https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=lIm9whaEHflyphBag4apumMnSNoPhmIew4xSC8To`;
  private static readonly loginUrl = `https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=lIm9whaEHflyphBag4apumMnSNoPhmIew4xSC8To`;
